...
<body>
  <!-- From Uiverse.io by micaelgomestavares -->
	...
	<div class="left-panel">
	    ...
	    <div class="logo-div"> <img src='../style/svg/LogoDiretoriaFundoTransparente.png' class='image'> </div>
	</div>
	<div class="right-panel">
	    <form class="form" action="../controllers/login_controller.php" method="post">

		<div class="flex-column">
		<label>Apelido ou Email </label>
		</div>
		<div class="inputForm">
		...
		<input type="text" class="input" placeholder="Digite seu Email ou Apelido" name="user">
		...
		<input type="password" class="input" placeholder="Digite sua Senha" name="pass" id="password">


		<svg viewBox="0 0 576 512" height="1em" xmlns="http://www.w3.org/2000/svg" class="password-toggle-view" id="togglePassword">
		...
		<p class="p">Não tem uma conta? <span class="span">Cadastre-se</span>
